...
class CustomLunarLander(gym.Env, EzPickle):
    ...
    def step(self, action):
        ...
        state = [(pos.x - VIEWPORT_W / SCALE / 2) / (VIEWPORT_W / SCALE / 2),
                 ...
                 20.0 * self.lander.angularVelocity / FPS, 1.0 if self.legs[0].ground_contact else 0.0,
...
if __name__ == '__main__':
    ...
    print(args)
    demo_heuristic_lander(CustomLunarLander(reward_shaping_coef=args.reward_shaping, continuous=args.continuous),
                          render=True)
