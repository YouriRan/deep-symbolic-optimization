...
class DeepSymbolicOptimizer(pl.LightningModule):
    ...
    def make_trainer(self):
        trainer = Trainer(self.sess, self.policy, self.policy_optimizer, self.gp_controller, self.logger, self.pool,
    ...
    def make_policy(self):
        policy = make_policy(self.sess, self.prior, self.state_manager, **self.config_policy)
        return policy
